...
const BASE_OUTPUT_DIR = "~/Career/Generated Assets";
...
const COVER_LETTERS = {
  ...
  "Process Street": {
    ...
    body1: "At Company A, I built end-to-end workflow automation across GoHighLevel and Stripe APIs, integrating payment processing, CRM automation, and client onboarding through no-code configuration. I implemented Notion API integrations with Calendly and Zapier to automate client scheduling, data sync, and lifecycle stage tracking. Through UAT-style testing and troubleshooting, I identified and resolved integration issues, reducing onboarding effort by 60%. At Company B, I built client onboarding automations using Calendly API and Zapier integrations, connecting scheduling data to Notion CRM for automated client record creation. I also implemented data migration from Google Sheets to Notion using API-based ETL scripts, migrating 700+ client records with validation and error handling.",
    body2: "My technical discovery and requirements gathering experience comes from a Big 4 firm, where I conducted stakeholder discovery sessions to elicit requirements and define functional specifications for enterprise software implementations. I built demonstrations and proofs of concept for technical solutions, presenting to stakeholders and iterating based on feedback. I translated business requirements into user stories and acceptance criteria for technical implementation teams, supporting Agile delivery through sprint ceremonies and backlog refinement.",
  ...
  "Motorola Solutions": {
    ...
    body1: "At a Big 4 firm, I served as a Business Analyst supporting Fortune 500 clients through enterprise IT transformations. I authored BRDs and FRDs to translate stakeholder needs into functional requirements, including business rules, functional specs, and edge cases. I built swimlane as-is/to-be process maps in Visio and translated requirements into user stories and acceptance criteria to guide implementation planning. I executed UAT by creating test plans and test cases and tracking defects in Jira, building executive dashboards and scenario models to support data-driven decisions. I supported Agile delivery by participating in backlog refinement and sprint ceremonies, maintaining story readiness and supporting go-live readiness activities.",
    body2: "At Company A and Company B, I applied these same business analysis capabilities to build operational systems from the ground up. At Company A, I built an end-to-end onboarding workflow across GoHighLevel and Stripe, automating processes and enforcing stage-gate rules. I built a Notion-based system of record by defining structured data models, reducing missed steps through standardized fields and required-stage completion. Through UAT-style testing and defect triage, I reduced onboarding effort from 3-5 hours to 1-2 hours per client. At Company B, I implemented a Notion CRM and migrated 700+ client records, establishing lifecycle stages and standardized fields. I cleaned and normalized legacy data using Python scripts and owned ongoing data quality to ensure consistent team entry.",
    body3: "My Computer Science background provides the technical foundation to understand complex IT architectures and translate them into business value. At a consulting firm, I drove cross-functional alignment across Product, Engineering, and Marketing to define customer retention strategy, developing predictive retention models in Python using behavioral data to identify at-risk customer segments.",
...
function generateCoverLetter(companyName, data) {
  ...
  const fileName = `Your_Name_CoverLetter_${companyName.replace(/\s+/g, '_')}.docx`;
...
function main() {
  ...
  setTimeout(() => {
    ...
    console.log("=" * 70);
    console.log("\nOutput structure:");
    console.log("~/Career/Generated Assets/");
    console.log("├── Vetcove/");
    console.log("│   ├── Your_Name_Resume_Vetcove.docx");
    console.log("│   └── Your_Name_CoverLetter_Vetcove.docx");
    console.log("├── Process Street/");
    console.log("│   ├── Your_Name_Resume_Process_Street.docx");
    console.log("│   └── Your_Name_CoverLetter_Process_Street.docx");
    console.log("├── Motorola Solutions/");
    console.log("│   ├── Your_Name_Resume_Motorola_Solutions.docx");
    console.log("│   └── Your_Name_CoverLetter_Motorola_Solutions.docx");
    console.log("└── HockeyStack/");
    console.log("    ├── Your_Name_Resume_HockeyStack.docx");
    console.log("    └── Your_Name_CoverLetter_HockeyStack.docx");
    console.log("=" * 70);
